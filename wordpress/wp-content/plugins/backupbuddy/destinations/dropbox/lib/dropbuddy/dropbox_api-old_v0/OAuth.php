...
abstract class Dropbox_OAuth {
     ...
     * @var string
     */
    const URI_REQUEST_TOKEN = 'http://api.dropbox.com0/oauth/request_token';
     ...
     * @var string
     */
    const URI_AUTHORIZE = 'http://api.dropbox.com0/oauth/authorize';
     ...
     * @var string
     */
    const URI_ACCESS_TOKEN = 'http://api.dropbox.com0/oauth/access_token';
