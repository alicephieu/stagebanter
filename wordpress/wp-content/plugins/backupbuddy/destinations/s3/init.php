...
class pb_backupbuddy_destination_s3 { // Change class name end to match destination name.
	...
	public static $destination_info = array(
		'name'			=>		'Amazon S3',
		'description'	=>		'Amazon S3 is a well known cloud storage provider. <b>BackupBuddy recommends this destination in addition to BackupBuddy Stash.</b> <a href="http://aws.amazon.com/s3/" target="_new">Learn more here.</a>',
	);
