...
class pb_backupbuddy_ui {
	...
	public function disalert( $unique_id, $message, $error = false ) {
		...
		if ( ! isset( pb_backupbuddy::$options['disalerts'][$unique_id] ) ) {
			$message .= '<a style="float: right;" class="pb_backupbuddy_disalert" href="#" title="' . __( 'Dismiss this alert. Unhide dismissed alerts on the Getting Started page.', 'it-l10n-backupbuddy' ) . '" alt="' . pb_backupbuddy::ajax_url( 'disalert' ) . '">' . __( 'Dismiss', 'it-l10n-backupbuddy' ) . '</a>';
