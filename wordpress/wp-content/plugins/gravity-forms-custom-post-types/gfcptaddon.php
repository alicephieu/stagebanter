...
class GFCPTAddon {
    ...
    public static function init(){
        ...
        if(self::is_gravityforms_installed()){
            ...
            require_once(self::get_base_path() . '/gfcptaddon_class.php');

            //include field properties include
            require_once(self::get_base_path() . '/includes/gfcpt_field_properties.php');
            
            //include js
            require_once(self::get_base_path() . '/includes/gfcpt_editor_js.php');
            
            $gf_cpt_addon = new GFCPTAddonLogic();
